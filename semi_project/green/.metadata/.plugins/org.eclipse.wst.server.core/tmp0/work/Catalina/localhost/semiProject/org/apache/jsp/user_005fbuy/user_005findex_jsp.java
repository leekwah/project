 ...
 * Generated at: 2022-09-23 13:36:21 UTC
...
public final class user_005findex_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	if (!session.getAttribute("id").equals("admin")) { // 관리자 계정으로 로그인하지 않는 경우에는 메인페이지로 이동하게 만듬
		response.sendRedirect("../main/main_user.jsp"); //메인화면으로 이동
	}
