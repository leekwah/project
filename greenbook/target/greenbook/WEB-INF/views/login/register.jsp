                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-4">
                            ...
                            <div class="input-group has-validation">
                                ...
                                <select class="form-select" id="user_phone1" required>
                        ...
                        <div class="col-4">
                            ...
                            <div class="input-group has-validation">
                                <input type="tel" class="form-control" maxlength="4" id="user_phone2" required>
                            </div>
                        </div>
                        <div class="col-4">
                            <label for="user_phone3" class="form-label"> &nbsp; </label>
                            <div class="input-group has-validation">
                                <input type="tel" class="form-control" maxlength="4" id="user_phone3" required>
                            </div>
                        </div>
