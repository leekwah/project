        ...
        <div class="row g-5">
            <div class="col-md-12 col-lg-12">
                <form class="needs-validation" novalidate action="register_ok" method="post">
                    <div class="row g-3">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="input-group has-validation">
                                <input type="text" class="form-control" name="member_id" id="member_id" placeholder="아이디를 적어주세요." required>
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" name="member_address" id="member_address" placeholder="주소" readonly required>
                            <div class="invalid-feedback">
                                올바른 주소를 입력하세요.
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <label for="member_extraAddress" class="form-label">참고항목</label>
                            <input type="text" class="form-control" name="member_extraAddress" id="member_extraAddress"  placeholder="참고항목" readonly>
                        </div>

                        <div class="col-md-6">
                            <label for="member_detailAddress" class="form-label">상세주소 <span class="text-muted">(선택)</span></label>
                            <input type="text" class="form-control" name="member_detailAddress" id="member_detailAddress" placeholder="상세주소 (선택)">
                        </div>
                    </div>
                    <br>
                    <br>
                    ...
                    <div class="col-12">
                        <button class="w-100 btn btn-outline-danger btn-lg" type="reset">다시적기</button>
                    </div>
