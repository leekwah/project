              ...
              <div class="row my-4">
                <div class="col-6 col-md-4">
                  <div class="card shadow mb-4">
                    <div class="card-body " onclick="document.location.href='main_user.jsp?pages=../qna/qnaList_u'" style="cursor:pointer;">
                      <i class="fe fe-info fe-32 text-primary"></i>
                        <h3 class="h5 mt-4 mb-1">Q&A</h3>
                ...
                <div class="col-6 col-md-4">
                  <div class="card shadow mb-4">
                    <div class="card-body " onclick="document.location.href='main_user.jsp?pages=../faq/faq_main'" style="cursor:pointer;">
                ...
                <div class="col-6 col-md-4">
                  <div class="card shadow mb-4">
                    <div class="card-body " onclick="document.location.href='../notice/noticeList_u.jsp'" style="cursor:pointer;">
                ...
                <div class="col-md-6">
                  <div class="card shadow bg-primary text-center mb-4">
                    <div class="card-body p-5">
                      ...
                      <a href="../user_log/mypage_user.jsp" class="btn btn-lg bg-primary-light text-white">My Page<i class="fe fe-arrow-right fe-16 ml-2"></i></a>
                    </div> <!-- .card-body -->
                  </div> <!-- .card -->
                </div> <!-- .col-md-->
                <div class="col-md-6">
                  <div class="card shadow bg-success text-center mb-4">
                    <div class="card-body p-5">
                      ...
                      <a href="../user_log/mypage_user" class="btn btn-lg bg-success-light text-white">Cart<i class="fe fe-arrow-right fe-16 ml-2"></i></a>
                    </div> <!-- .card-body -->
                  </div> <!-- .card -->
                </div> <!-- .col-md-->
              </div> <!-- .row -->
