        ...
        <form class="col-lg-6 col-md-8 col-10 mx-auto" name="reg_frm" action="registerOk.jsp" method="post">
          ...
          <div class="row mb-12">
            <div class="col-md-12">
              ...
              <div class="form-group">
                <label for="inputPassword6">이름</label>
          ...
          <div class="form-row">
	          <div class="col-md-4 mb-3">
	            ...
	            <input type="text" class="form-control" id="validationCustom01" name="user_phone1" maxlength="4" required>
	          </div>
	          <div class="col-md-4 mb-3">
	            <label for="phone2"> &nbsp;   &nbsp;   &nbsp; </label>
	            <input type="text" class="form-control" id="validationCustom02" name="user_phone2" maxlength="4" required>
	          </div>
	          <div class="col-md-4 mb-3">
	            <label for="phone3"> &nbsp;   &nbsp;   &nbsp; </label>
	            <input type="text" class="form-control" id="validationCustom02" name="user_phone3" maxlength="4" required>
	          </div>
          </div>
          <div class="form-group">
